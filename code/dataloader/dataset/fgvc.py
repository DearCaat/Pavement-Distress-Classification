...
class Dog(Dataset):
    ...
    def load_split(self):
        if self.train:
            split = io.loadmat(join(self.root, 'train_list.mat'))['annotation_list']
            labels = io.loadmat(join(self.root, 'train_list.mat'))['labels']
        else:
            split = io.loadmat(join(self.root, 'test_list.mat'))['annotation_list']
            labels = io.loadmat(join(self.root, 'test_list.mat'))['labels']
